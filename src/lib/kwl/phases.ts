...
// of SIA 382/5:2021 (and the SIA 108 basic services); `ref` names the clause to look up in the norm.
  ...
  },
  {
    ...
    sections: [
      ...
      list("device", t("Lüftungsgerät und Komponenten", "Appareil de ventilation et composants", "Apparecchio di ventilazione e componenti"), [
        ...
        i("p32.hr", "2.3.6", "Wärmerückgewinnung erfüllt SIA 382/1 Ziffer 5.10 bzw. VO (EU) 1253/2014.", "Récupération de chaleur conforme à SIA 382/1 ch. 5.10 ou au règlement (UE) 1253/2014.", "Recupero di calore conforme a SIA 382/1 cifra 5.10 o al regolamento (UE) 1253/2014."),
      ...
      list("install", t("Installation, Bedienung, Brandschutz, Abschluss", "Installation, commande, protection incendie, clôture", "Installazione, comando, antincendio, chiusura"), [
        ...
        i("p32.insulation", "5.5.4", "Wärmedämmung der Leitungen und Geräte nach SIA 382/1 Ziffer 5.9.", "Isolation des conduits et appareils selon SIA 382/1 ch. 5.9.", "Isolamento di condotte e apparecchi secondo SIA 382/1 cifra 5.9."),
  ...
  },
  {
    ...
    sections: [
      list("permit", t("Baugesuch und Nachweise", "Demande de permis et justificatifs", "Domanda di costruzione e prove"), [
        ...
        i("p33.energy", "3.3.5", "Energienachweis (Vollzugshilfe EnFK EN-4 Lüftungstechnische Anlagen) erstellt.", "Justificatif énergétique (aide à l’application EnDK EN-4 installations de ventilation) établi.", "Prova energetica (aiuto all’esecuzione EnDK EN-4 impianti di ventilazione) allestita."),
